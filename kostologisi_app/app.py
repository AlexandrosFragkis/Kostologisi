...
def_furniture_reference = {
    "Ντουλάπα ανοιγόμενη από 1,60 μ. εώς 4 συρτάρια (Εσωτερικά Μελαμίνη)": {
        "Μελαμίνη": 320,
        "Λάκα ματ/σατινέ": 400,
        "Λάκα ζαγρέ": 430,
    ...
    "Ντουλάπα συρόμενη από 1,60 μ. εώς 4 συρτάρια (Εσωτερικά Μελαμίνη)": {
        "Μελαμίνη": 400,
        "Λάκα ματ/σατινέ": 480,
        "Λάκα ζαγρέ": 520,
        "Καπλαμάς δρυς": 550,
...
if "clear_furniture" not in st.session_state:
    st.session_state.clear_furniture = False

if st.session_state.clear_furniture:
    st.session_state.furniture_list = []
    st.session_state.clear_furniture = False
...
if st.session_state.furniture_list:
    ...
    if st.button("Επαναφορά Λίστας"):
        st.session_state.clear_furniture = True
        st.rerun()
